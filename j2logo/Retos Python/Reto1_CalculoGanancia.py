...
Entrada: Los valores de cada producto en una #línea de código diferente.
...
1000                - Unidades Disponibles: 1000
                    - Ganancia: $250000 
"""
Producto = str(input("Digite nombre del producto: "))
CU = int(input("Digite costo unitario del producto: "))
PVP = int(input("Digite el precio de venta al público: "))
UD = int(input("Digite la cantidad de unidades disponibles: "))
